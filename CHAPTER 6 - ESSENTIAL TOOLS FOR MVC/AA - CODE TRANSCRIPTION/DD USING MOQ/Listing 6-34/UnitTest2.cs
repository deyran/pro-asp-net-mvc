    ...
    */
    ...
    public class UnitTest2
    {
        ...
        public void Pass_Through_Variable_Discounts()
        {
            ...
            mock.Setup(m => m.ApplyDiscount(It.IsInRanger<decimal>(10, 100, Range.Inclusive))).Returns<decimal>(total => total - 5);
            ...
            // assert
            Assert.AreEqual(5, FiveHundredDollarDiscount, "$5 Fail");
